  ...
  const fetchData = async (category) => {
    try {
      ...
      const response = await axios.get(url, {
        headers: {
          Authorization:
            "Bearer eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ3dW5zb2hvQG1haWwudWxzYW4uYWMua3IiLCJlbWFpbCI6Ind1bnNvaG9AbWFpbC51bHNhbi5hYy5rciIsImlhdCI6MTcwNzk4MTczMiwiZXhwIjoxNzA3OTg4OTMyfQ.kJrMW-sJKm3gXZxs_apst6X_UujVL6DPJe9wVNO-mPU",
        },
      });
