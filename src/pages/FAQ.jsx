    ...
    try {
      const response = await axios.get(
        `http://13.125.247.248:8080/api/v1/faq/list?type=${sort}&page=1`,
        {
          headers: {
            Authorization:
              "Bearer eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ3dW5zb2hvQG1haWwudWxzYW4uYWMua3IiLCJlbWFpbCI6Ind1bnNvaG9AbWFpbC51bHNhbi5hYy5rciIsImlhdCI6MTcwNzgyODgzNSwiZXhwIjoxNzA3ODM2MDM1fQ.HRpppr3JsWgPx7paTs7zqNE8NwttLglgFgp8Wj3WtlA",
          },
        }
      );      
