    ...
    const fetchData = async () => {
      try {
          const result = await axios.get(
            ...
            {
              headers: {
                Authorization: "Bearer eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ0ZXN0MTExMUBtYWlsLnVsc2FuLmFjLmtyIiwiZW1haWwiOiJ0ZXN0MTExMUBtYWlsLnVsc2FuLmFjLmtyIiwiaWF0IjoxNzA3NjM0NjgzLCJleHAiOjE3MDgxNTMwODN9.YTc1heUI2h761Jgg4HI8LMHmK97c5AVROknvWE0qJ5Q",
              },
            }
          );
