    ...
    return(
        <div style={{fontFamily: "Pretendard"}}>
            ...
            <Link to="/search" target="_self">
                <img src={search1} alt="검색" style={{float:"right", marginTop:"2vh", marginRight: "3vw", borderRadius:"4vw"}}/>
            </Link>
            <img src={alert} alt="알림" style={{float:"right", marginTop:"2vh", marginRight: "4vw", borderRadius:"4vw"}}/>
        </div>
    );
}
